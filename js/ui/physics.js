...
export function initPhysics({
  ...
  function disablePhysicsUser() {
    ...
    const view = snapshotView();
    stabilizeThenDisable(view, settleIterations);
  }
  ...
  // After the network does its initial stabilization, switch to "live" physics without stabilization.
  // (This mirrors your inline logic.)
  network.once("stabilized", () => {
    applyLiveOptionsPreserveView();
  });
